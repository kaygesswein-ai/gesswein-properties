    ...
    <main className="bg-white">
      ...
      <section className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="pl-2 sm:pl-4 mb-4 flex gap-2">
            <button
              ...
              className={`px-3 py-2 text-sm rounded-none border ${
                advancedMode === 'rapida' ? 'bg-gray-200 border-gray-300 text-slate-900' : 'bg-gray-50 border-gray-300 text-slate-700'
              }`}
            >
              Búsqueda rápida
            </button>
          ...
          {advancedMode === 'rapida' && (
            <>
              ...
              <div className="pl-2 sm:pl-4 mt-3 grid grid-cols-1 lg:grid-cols-5 gap-3">
                {/* === Moneda con SmartSelect (UF / CLP / CLP$) === */}
                <SmartSelect
                  options={['UF', 'CLP', 'CLP$']}
                  value={moneda}
          ...
          {/* === AVANZADA (solo mismo cambio de formato en selects) === */}
          {advancedMode === 'avanzada' && (
            <>
              <div className="pl-2 sm:pl-4">
