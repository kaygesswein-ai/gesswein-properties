...
export default function PropiedadesPage() {
  ...
  // UF / CLP (mismo control que operación)
  ...
  useEffect(() => {
    ...
    // llamada real en tu proyecto; aquí sólo para mantener la interfaz
            ...
            >
              ...
              <div className="p-4 flex flex-col">
                ...
                <div className="mt-4 flex items-center justify-between">
                  {/* Ver más: blanco con borde azul, texto oscuro */}
                  <span
                  ...
                  <div className="text-right font-semibold" style={{ color: BRAND_BLUE }}>
                    <div>UF 10.500</div>
