...
export default function PropiedadesPage() {
  ...
  const handleFiltersChange = (f: Filters) => { setFilters(f); fetchProperties(f); };
  const handleClearFilters = () => { setFilters({}); fetchProperties({}); };

  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Propiedades Disponibles</h1>
        ...
        <div className="space-y-6">
          ...
          {!loading && properties.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">Ajusta los filtros para ver más opciones</p>
