...
/** ✅ FIX TS: evita comparar contra '' cuando TS ya redujo el tipo */
...
export default function ProyectosExclusivosPage() {
  ...
  const displayedItems = useMemo(() => {
    ...
    if (
      sortMode === 'bajo_mercado' ||
      sortMode === 'novacion' ||
      sortMode === 'flipping' ||
      sortMode === 'densificacion'
    ) {
      ...
      <section className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="pl-2 sm:pl-4 max-w-4xl">
            <h2
              className="text-lg md:text-xl uppercase tracking-[0.25em]"
            ...
            <div className="mt-5 text-slate-700 leading-relaxed space-y-4">
              <p>
                No todas las oportunidades inmobiliarias llegan al mercado abierto. Algunas requieren
                criterio técnico, red estratégica y capacidad de estructuración.
              </p>
              <p>
                En esta sección presentamos activos singulares y proyectos especiales que, por su
                modelo de negocio, oportunidad financiera o particularidad normativa, se gestionan
                bajo un esquema diferenciado y, en muchos casos, confidencial.
              </p>
              <p>
                Aquí encontrarás alternativas que no compiten en el mercado masivo: novaciones
                estructuradas, operaciones de flipping con fundamento técnico, propiedades bajo valor
                de mercado y activos con potencial de densificación o desarrollo.
              </p>
              <p>
                Cada oportunidad es previamente analizada desde su viabilidad normativa, potencial
                constructivo, escenario de valorización y riesgo asociado. No se trata solo de
                “precio atractivo”, sino de activos con lógica financiera y fundamento técnico.
              </p>
              <p>
                El acceso a esta sección es limitado y su disponibilidad cambia constantemente según
                oportunidades reales detectadas y gestionadas por nuestro equipo.
              </p>
              <p>
                Gesswein Properties no publica volumen. Gestiona oportunidades que requieren visión,
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              <div className="border border-slate-200 p-4">
                ...
                <p className="mt-2 text-slate-700 leading-relaxed">
                  Identifica activos cuyo precio de oferta se encuentra por debajo de referencias
                  observables y comparables, conforme a una evaluación preliminar de mercado
                  (comparable sales, stock activo y condiciones de cierre). Su objetivo es resaltar
                  oportunidades donde la hipótesis central es una valorización por convergencia a
                  precio de mercado.
                </p>
              </div>
              ...
              <div className="border border-slate-200 p-4">
                ...
                <p className="mt-2 text-slate-700 leading-relaxed">
                  Señala activos en que existe la posibilidad de estructurar una novación
                  hipotecaria (o mecanismo equivalente) que permita acceder a condiciones de
                  financiamiento preexistentes. El porcentaje visible corresponde a la tasa
                  referencial asociada a la operación y se presenta con decimales para precisión
                  comparativa.
                </p>
              </div>
              ...
              <div className="border border-slate-200 p-4">
                ...
                <p className="mt-2 text-slate-700 leading-relaxed">
                  Identifica activos donde existe una hipótesis razonable de mejora de valor en el
                  corto/mediano plazo mediante intervención (remodelación, regularización,
                  reposicionamiento comercial u optimización funcional), con salida proyectada y
                  criterios mínimos de margen y liquidez.
                </p>
              </div>
              ...
              <div className="border border-slate-200 p-4">
                ...
                <p className="mt-2 text-slate-700 leading-relaxed">
                  Indica activos con potencial de densificación o desarrollo inmobiliario, sujeto
                  a verificación normativa (instrumentos de planificación, coeficientes,
                  afectaciones, cabidas, restricciones y factibilidad). Su foco es resaltar
                  oportunidades donde la creación de valor proviene de la mejor explotación del
                  suelo.
                </p>
              </div>
            </div>
                        ...
                        <div className="border border-slate-200 p-2">
                          ...
                          <div className="text-sm">
                            {p.superficie_terreno_m2 != null
                              ? nfINT.format(p.superficie_terreno_m2)
                              : '—'}
                          </div>
                        </div>
                      </div>
